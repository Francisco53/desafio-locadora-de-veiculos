...
import com.solutis.desafiolocadora.services.FuncionarioService;
...
public class FuncionarioController {
	...
	@GetMapping(value = "/{id}")
	@Operation(summary = "Listar informações de um funcionário através de seu ID")
	...
	@Operation(summary = "Remover um funcionário através de seu ID")
	...
	@PutMapping(value = "/{id}")
	@Operation(summary = "Atualizar um funcionário através de seu ID")
